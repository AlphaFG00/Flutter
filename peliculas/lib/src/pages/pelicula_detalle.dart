...
class PeliculaDetalle extends StatelessWidget {
  ...
  //los slivers son como widgets normales, pero mas fresones o mamados

  @override
  Widget build(BuildContext context) {
     //mandar argumentos mediante push named
                  ...
                  Row(children: <Widget>[
                      ...
                      Flexible(
                        child: Column(
                          ...
                          children: <Widget>[                                                           //para titulos largos
      ...
      return Container(
        ...
        [
          ClipRRect(
            ...
            child: FadeInImage(placeholder: AssetImage('assets/img/loading.gif'), image: NetworkImage(actor.getFoto()),
            height: 150.0,
            fit: BoxFit.cover,
